<div class="mt-10 bg-red-500">
  <h1>Hello</h1>
    ...
    <?php foreach ($users as $user): ?>
      <?php if ($user->name === 'Camden Kozey' && !$user->email_verified_at): ?>
      <p><?= htmlspecialchars($user->name, ENT_QUOTES, "UTF-8") ?> is active</p>
      <?php endif; ?>
    <?php endforeach; ?>
</div>
  ...
  <div class="container py-5 h-100 mt-3">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-lg " style="border-radius: 1.5rem; backdrop-filter: blur(10px); background: rgba(255, 255, 255, 0.95);">
            ...
            <form action="/register" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-4">
                <label for="formFile" class="form-label fw-semibold text-dark mb-3">
                  <i class="fas fa-cloud-upload-alt me-2 text-primary"></i>Profilkép feltöltése (opcionális)
                </label>
                <div class="border-2 border-dashed rounded-3 p-4 text-center " style="border-color: #dee2e6 !important; background: #f8f9fa;">
